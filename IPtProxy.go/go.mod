...
require (
	...
	gitlab.torproject.org/tpo/anti-censorship/pluggable-transports/lyrebird v0.0.0-20260217103931-fa56bc4acf39
	gitlab.torproject.org/tpo/anti-censorship/pluggable-transports/snowflake/v2 v2.12.1
